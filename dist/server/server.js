...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CRiHQR1s.js");
...
const manifest = { "f82fe0a8823169db464e13d5360ffb9c7ccf24363fad78ef08fde052634583c2": {
  functionName: "getNotes_createServerFn_handler",
  importer: () => import("./assets/notes-Ct2Q_q0L.js")
}, "adf580c99fe4703be66856341616b124bacfeb6f1f282e1c6e4d7c60686bf5c1": {
  functionName: "createNote_createServerFn_handler",
  importer: () => import("./assets/notes-Ct2Q_q0L.js")
}, "8cd0049a2c6d3795ac04002ca8d0fdd5a5a70a8980aa24b7c51f9d36b6d1ff87": {
  functionName: "updateNote_createServerFn_handler",
  importer: () => import("./assets/notes-Ct2Q_q0L.js")
}, "2f477c26e719e33c03cb4057a2c6bd9e41c72ef1f2554aa8cd40762c5bc1a94d": {
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-AH-gXfXx.js").then((n) => n.r);
    }
    if (startEntry === null) {
